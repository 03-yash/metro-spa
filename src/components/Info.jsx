  ...
  return (
    <div className='bg-pink-400 font-bold text-white items-center flex justify-center w-full h-16 font-body'>
        <span className='text-sm  sm:space-x-11 sm:flex sm:justify-between '>
            ...
            <p className='flex items-center justify-center '> <span className='mr-2'><FaPhone /></span> <span className='hover:underline cursor-pointer'>0731-19941609</span> <span className='ml-2 hover:underline cursor-pointer'>7440744919</span></p>
        </span>
    </div>
  )
}
