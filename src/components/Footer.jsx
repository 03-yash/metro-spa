  ...
  return (
    ...
    <div className="rest pb-5">
        <div className="info flex flex-col items-start justify-start space-y-7 mt-12 pl-4 text-gray-700 font-highlight">
            ...
            <p className='flex items-center justify-center '> <span className='mr-2'><FaPhone className=' text-pink-500' /></span> <span className='hover:underline cursor-pointer'>0731-19941609</span> <span className='ml-2 hover:underline cursor-pointer'>74407404919</span></p>
